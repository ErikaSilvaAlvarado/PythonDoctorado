...
os.chdir(r'C:\Users\Erika\OneDrive - Universidad de Guanajuato\Giselle\INTERFEROMETRO_20_08_21\Láser\Temperatura')
...
fig1.update_layout(title="Laser Giselle Temp Inc")
fig1.show()
