...
os.chdir(r'C:\Users\Erika\OneDrive - Universidad de Guanajuato\Giselle\INTERFEROMETRO_20_08_21\Dec')
xRange = [1520,1570]
#temperatura
...
fig1.update_layout(title="MZI Giselle under Temperature Dec.")
fig1.show()
