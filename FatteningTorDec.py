...
os.chdir(r'C:\Users\Erika\OneDrive - Universidad de Guanajuato\Fattening\Interferometro 6cm\6cmTorsionDescendente')
xRange = [1510,1580]
#temperatura
...
fig1.update_layout(title="MZI Fattening vs Torsion Dec.")
fig1.show()